...
import io.github.easy30.vue4j.util.resource.BaseResource;
import io.github.easy30.vue4j.util.resource.ClassPathResource;
import io.github.easy30.vue4j.util.resource.FileResource;
...
public class VueCache {
     ...
     * 带缓存的转换逻辑，避免重复读取和转换。
     * <p>
     * 热更新自动决定：仅当 vue4j.resource.root 为本地文件路径（非 classpath）时才检查文件变化；
